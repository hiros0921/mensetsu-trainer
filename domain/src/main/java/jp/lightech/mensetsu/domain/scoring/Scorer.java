 ...
 * {@link ScoringPolicy} の仕事で、その基準は諏訪が決める（仕様書7章）。
 *
...
public final class Scorer {
   ...
   *
   * 「特にありません」を逃げとみなさない立場もあるが、採らなかった。諏訪の判断:
   *
   ...
   *
   * <p>3つに重みを付けない。付けるならそれも諏訪の判断になり、決めるべき数値が増える。
   ...
   * 第1段階の懸念③に書いたとおり。重みを決めるときは、そのことが前提になる。
   *
